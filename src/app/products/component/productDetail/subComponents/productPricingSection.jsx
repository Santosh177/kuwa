      ...
      <>
        ...
        <div className={styles.buyNow} onClick={() => handelBuyNow()}>
          <span>Buy Now</span>
           ...
           { window && window.ApplePaySession && <div style={{marginTop:'24px',cursor:normalInventory <=0 || selectedVariantQuantity<=0 ? 'not-allowed':'pointer'}} disabled={normalInventory <=0 || selectedVariantQuantity<=0 } onClick={()=>onHandleApplePay()}>
