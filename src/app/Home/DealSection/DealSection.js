...
import DealHeaderTimer from '@/components/DealHeaderTimer/DealHeaderTimer';
...
const DealSection = ({ data }) => {
    ...
    const { heading, backgroundImageUrl, countDownEndsAt, countDownStartsAt,currentTimeStatus="", countryId, id, isDealActive,currentTimerValue="", isTimerActive, tagIconUrl, seoUrl, tag } = deal || {};
        ...
        <>
            {isDealActive && dealProductVariantDtoList.length>0 && (
                ...
                <div className={styles.dealContainer}>
                    ...
                    <DealHeaderTimer isDealActive={isDealActive} isTimerActive={isTimerActive} currentTimerValue={currentTimerValue} currentTimeStatus={currentTimeStatus} heading={heading} seoUrl={seoUrl}/>
