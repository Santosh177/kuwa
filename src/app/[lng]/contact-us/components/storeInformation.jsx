    ...
    return (
        <div className={style.storeInformationContainer}>
            ...
            <div className={style.locationCotainer}>
                ...
                <div className={style.discriptionText}>Kuwa Supplements, Valeo Wellbeing Technologies DMCC 1JLT-Nook-178 One JLT Plot No: DMCC-EZ1-1AB, Jumeirah Lakes Towers, Dubai, UAE</div>
            </div>
