  ...
  if(variantId){
    if(dealId && isDealActive && isTimerActive &&  currentTimerStatus == "in-between"){
      cardData = {
        ...
        "productId":productId || "",
        "variantId":variantId,
        "productImage":variantImage || "https://d25uasl7utydze.cloudfront.net/assets/no_image.png",
    ...
    if(dealId && isDealActive && isTimerActive &&  currentTimerStatus == "in-between"){
      cardData = {
        ...
        "productId":productId || "",
        "variantId":variantId,
        "productImage":productImage || "https://d25uasl7utydze.cloudfront.net/assets/no_image.png",
        "productName":productName || "",
        "productNameArabic":productNameArabic || "",
        "seoUrl":productSeoUrl,
        "retailPrice":dealListPrice,
