    ...
    return(
        <div className={styles.pageHeader}>
            ...
            <div className={styles.headerContent}>
                <img className={styles.backArrow} onClick={()=>router.back()} src='https://production-website-builds.s3.ap-south-1.amazonaws.com/kuwa/back_arrow+%281%29.png' alt='back-arrow'/>
